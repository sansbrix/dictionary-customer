          ...
          >
            ...
            <TouchableOpacity onPress={() => props.navigation.navigate('Translate Word')}>
                <View style={[styles.plans_div, styles.m_top_50]}>
                  ...
                  <View>
                    <Text style={styles.plan_label}>Dictionary</Text>
                  </View>
                </View>
              </TouchableOpacity>
                ...
                <TouchableOpacity onPress={() => props.navigation.navigate('Learning Track')}>
                  <View style={styles.plans_div}>
                    <View style={styles.cat_image_container}>
                    <Ionicons name="md-bookmarks" size={32} color="#756765" />
                    </View>
                    <View>
                      <Text style={styles.plan_label}>Learning</Text>
                    </View>
                  </View>
                </TouchableOpacity>
                
                <TouchableOpacity onPress={() => props.navigation.navigate('Add User-defined Word')}>
                  <View style={styles.plans_div}>
                    <View style={styles.cat_image_container}>
                ...
                <TouchableOpacity onPress={() =>props.navigation.navigate('Alphabets')}>
                  <View style={styles.plans_div}>
                    <View style={styles.cat_image_container}>
                    <Ionicons name="md-text" size={32} color="#756765" />
                    </View>
                    <View>
                      <Text style={styles.plan_label}>Alphabets</Text>
                    </View>
                  </View>
                </TouchableOpacity>
            </ScrollView>
